          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<EstadoEnvio>(
                value: _estado,
                isExpanded: true, // Permite que el dropdown se expanda para evitar overflow
                decoration: InputDecoration(
                  labelText: 'Estado',
            ...
            child: _selectedPdfFile != null || _pdfUrl != null
                    ? Column(
                        children: [
                          ...
                          const SizedBox(height: 12),
                          // Botones adaptativos: vertical en pantallas pequeñas, horizontal en grandes
                          Builder(
                            builder: (context) {
                              // Usar MediaQuery en lugar de LayoutBuilder para evitar conflictos
                              final screenWidth = MediaQuery.of(context).size.width;
                              // Si el ancho es menor a 300px, usar layout vertical
                              if (screenWidth < 300) {
                                return Column(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
                                ...
                                // Layout horizontal con botones flexibles
                                return Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: [
                                    Expanded(
